        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    ...
                    Almacénalos en un gestor de contraseñas seguro.
                </CardDescription>
            </CardHeader>
            <CardContent>
                            ...
                            <>
                                ...
                                <div className="text-xs text-muted-foreground select-none">
                                    <p id="regenerate-warning">
                                        Cada código de recuperación puede ser
                                        utilizado una vez para acceder a tu
                                        cuenta y se eliminará después de su
