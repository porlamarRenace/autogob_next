    ...
    const authConfigContent = useMemo<{
        ...
        if (showRecoveryInput) {
            return {
                ...
                toggleText: 'Iniciar usando un código de autenticación',
            };
        }
        ...
        return {
            ...
            description:
                'Introduce el código de autenticación proporcionado por tu aplicación de autenticador.',
            toggleText: 'Iniciar usando un código de recuperación',
        };
    }, [showRecoveryInput]);
